...
import Excepciones.WrongDeliveryDayException;
...
public class pedidosDao implements Dao<pedido> {
    ...
    public void save(pedido t) throws Exception {
    	...
    	try {
			helper.WrongOrderDayCreationException(t.getFecha_pedido(), t.getFecha_entrega());
			helper.WrongDeliveryDayException(t.getFecha_pedido());
		} catch (WrongOrderDayCreationException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}catch (WrongDeliveryDayException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
